...
<head>
  ...
  <title>Pengendalian Massa Polri (DALMAS)</title>
...
<body>
    ...
    <div class="container-fluid h-100">
      <div class="row h-100 align-items-center text-white">
        ...
        <div class="col-2 d-flex justify-content-center align-items-center">
          <img src="{{ asset('assets/images/logo/dalmas.png') }}" alt="Logo OPS POLRI" style="max-height: 100px; height: auto;">
        </div>
  
        <!-- Gambar Tengah dengan Teks -->
        <div class="col-8 position-relative h-100">
          <img src="{{ asset('assets/images/bg/bgheader.jpg') }}" alt="Gedung Polda" class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover" style="z-index: 1; opacity: 0.6;"/>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand fw-bold" href="#">Pengendalian Massa Polri</a>
  ...
  <footer class="bg-light text-center py-3 mt-auto border-top">
    <div class="container">
      ...
      <ul class="list-unstyled mb-1">
        <li><a href="https://polri.go.id/" target="_blank" class="text-decoration-none">https://polri.go.id/</a></li>
      </ul>
    </div>
  </footer>
